                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                        <button type="button" class="btn btn-warning" id="<?php echo $row["r_id"]; ?>" data-toggle="modal" data-target="#editModal">Edit</button>


                                        <!-- <a class="btn btn-warning editbtn" data-id="<?php $row["r_id"]; ?>" data-toggle="modal" data-target="#editModal">Edit</a> -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="refrigarent_control.php">
                    ...
                    <div class="modal-body" id="edit_test">
...
$(document).ready(function(){
    $(document).on('click', '.editbtn', function){
        var refrig_id = $(this).arrt("r_id");
        $.ajax({
            url:"fetch.php",
            method:"POST",
            data:{refrig_id:refrig_id},
            dataType:"json",
